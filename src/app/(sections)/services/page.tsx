...
export default function Services() {
    return (
        <section id="servicios" className="services section bg-gray-light-color py-20">
          <div className="container mx-auto min-h-screen ">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 justify-center items-center">
              ...
              <article className="service-card p-6 text-center bg-white shadow-lg rounded-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Programación <i>Web</i></h3>
                <p className="text-gray-600">Desarrollo de proyectos utilizando tecnologías como Next.js con TypeScript y React</p>
              </article>
              ...
              <article className="service-card p-6 text-center bg-white shadow-lg rounded-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Diseño <i>Web</i></h3>
                <p className="text-gray-600">Planificación, diseño y creación de interfaces digitales <i>Web</i></p>
              </article>
            </div>
          </div>
        </section>
