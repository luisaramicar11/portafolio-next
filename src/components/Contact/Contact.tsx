...
export default function Contact() {
    return (
        <section id="contact" className={`${styles['hero-image']} bg-cover bg-center w-screen py-10`}>
          <h2 className="mt-0 my-8 py-2 text-center text-black text-3xl font-bold w-64 mx-auto mb-20">
              CONTACT
            </h2>
            <article className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <aside className="m-4 p-4 w-full h-36 flex flex-col justify-around items-center">
                <svg
                  width="37"
                  height="28"
                  viewBox="0 0 37 28"
                  ...
                  className="w-8 h-8 fill-white-color"
                >
                  <path
                ...
                <small className="text-black-color mt-4">Medellín-Antioquia, Colombia</small>
              </aside>
              <aside className="m-4 p-4 w-full h-36 flex flex-col justify-around items-center">
                <svg
                  width="33"
                ...
                <small className="text-gray-500 mt-4">
                  <a href="https://wa.me/3206992710?text=¡Hola!" className="text-black-color">
                    +57 3206992710
                  </a>
                </small>
              </aside>
              <aside className="m-4 p-4 w-full h-36 flex flex-col justify-around items-center">
                ...
                <small className="text-gray-500 mt-4">
                  <a href="mailto:lfernanda1192@gmail.com" className="text-black-color">
